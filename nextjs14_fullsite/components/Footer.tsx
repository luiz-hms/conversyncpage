                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-600 max-w-md mb-4">
                            A plataforma de atendimento inteligente omnichannel que
                            revoluciona a forma como você se comunica com seus clientes.
                        </p>
                        <div className="flex gap-4">
                            <a
                                href="#"
                                className="w-10 h-10 bg-gray-100 hover:bg-green-100 rounded-lg flex items-center justify-center transition-colors group"
                            >
                                <svg
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-center gap-2 text-gray-600">
                                ...
                                <span className="text-sm">contato@conversync.com.br</span>
                            </li>
                            <li className="flex items-center gap-2 text-gray-600">
                ...
                <div className="pt-8 border-t border-gray-200">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-gray-600 text-sm">
                            © {currentYear} ConverSync. Todos os direitos reservados.
                        </p>
